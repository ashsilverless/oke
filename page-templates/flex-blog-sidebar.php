...
<div class="outer-wrapper mt3">
    <div class="container pr1 pl1 cols-14-10 cols-md-24 border-split">
        <div class="col pr3 pr0-mob">
            ...
            <div class="toggle mb3">
                <?php if( have_rows('items') ):
                    ...
                    <?php if (get_sub_field('a_bio') == 'true'){?>
                        
                    <div class="toggle__item <?php the_sub_field('open');?> bio-toggle">
            ...
            <div class="cta mt5 mb5" style="background-image: url(<?php echo $ctaImage['url']; ?>);">
                <div class="container align-center pt5 pb3">
                    <div class="col">
                        <div class="content lg-narrow">
                            <h3 class="heading heading__md heading__caps heading__light">
